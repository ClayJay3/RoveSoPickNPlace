...
namespace Kroft.Api.Entities
{
    public class AccountsRepository : IAccountsRepository
    {
        ...
        private readonly KroftDatabase _KroftDatabase;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="db">Implicitly passed in.</param>
        public AccountsRepository(KroftDatabase db)
        {
            _KroftDatabase = db;
        }
        ...
        public async Task<UserProfile?> AddUserProfile(UserProfile userProfile)
        {
            ...
            var result = await _KroftDatabase.UserProfiles.AddAsync(userProfile);
            await _KroftDatabase.SaveChangesAsync();
        ...
        public async Task<UserProfile?> DeleteUserProfile(System.Guid userID)
        {
            ...
            UserProfile? result = await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.ID == userID);
            // Check if it was found.
            if (result is not null)
            {
                // Remove the row from the database.
                _KroftDatabase.UserProfiles.Remove(result);
                await _KroftDatabase.SaveChangesAsync();
            }
            return result;
        }
        ...
        {
            // Find the first user profile with the same ID.
            UserProfile? result = await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.ID == userProfile.ID);
            // Check if it was found.
            if (result is not null)
            {
                // Update the row in the database.
                _KroftDatabase.UserProfiles.Update(userProfile);
                await _KroftDatabase.SaveChangesAsync();
            }
            return result;
        }
        ...
        {
            return await _KroftDatabase.UserProfiles.ToListAsync();
        }
        ...
        {
            return await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.ID == userID);
        }
        ...
        {
            return await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.Email == email);
        }
        ...
        {
            return await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.PhoneNumber == phoneNumber);
        }
        ...
        {
            return await _KroftDatabase.UserProfiles.FirstOrDefaultAsync(x => x.Username == username);
        }
        ...
        public async Task<bool> IsUsernameAvailable(string username)
        {
            ...
            return await _KroftDatabase.UserProfiles.AnyAsync(x => x.Username == username) == false;
        }
        ...
        public async Task<bool> IsEmailAvailable(string email)
        {
            ...
            return await _KroftDatabase.UserProfiles.AnyAsync(x => x.Email == email) == false;
        }
        ...
        public async Task<bool> IsPhoneNumberAvailable(string phoneNumber)
        {
            ...
            return await _KroftDatabase.UserProfiles.AnyAsync(x => x.PhoneNumber == phoneNumber) == false;
        }
